...
function init() {
  ...
  const catStartPosition = 52 // starting position of the cat (refers to an index)
  let catCurrentPosition = 52 // use let to track where the cat currently is (refers to an index)
